<template>
  <header class="bg-gray-500 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
    <div class="flex items-center justify-between px-4 py-3 sm:p-0">
      <div class="w-12 rounded-xl">
        <img src="../../../assets/img/MIRRORS-logo.jpg" alt="">
      </div>
      <div class="sm:hidden">
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-4 sm:flex sm:p-0">
      ...
      <a href="#" class="mt-1 block px-2 py-1 text-white font-semibold rounded hover:bg-gray-800 sm:mt-0 sm:ml-2">Feedback</a>
